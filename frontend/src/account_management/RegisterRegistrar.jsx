...
const RegisterRegistrar = () => {
    ...
    const handleSubmit = async (e, passwordChangeConfirmed = false) => {
        ...
        try {
            ...
            if (editData) {
                // EDIT registrar
                await axios.put(`${API_BASE_URL}/api/update_registrar/${editData.id}`, fd, {
                    headers: {
    ...
    return (
        ...
        <Box sx={{ height: "calc(100vh - 150px)", overflowY: "auto", paddingRight: 1, backgroundColor: "transparent", mt: 1, padding: 2 }}>
            ...
            <Dialog
                ...
                onClose={() => { setOpenDeleteDialog(false); setRegistrarToDelete(null); }}
                maxWidth="xs"
                fullWidth
            ...
            >
                ...
                <DialogContent sx={{ p: 3, mt: 2 }}>
                    ...
                    <Typography sx={{ color: "#d32f2f", fontSize: "0.95rem" }}>
                        Deleting this registrar will permanently remove their account from the system.
                        <br />
                        All access privileges and records associated with this registrar
                        may be affected.
                    </Typography>
                </DialogContent>
                ...
                <DialogActions sx={{ px: 3, py: 2, borderTop: "1px solid #e0e0e0" }}>
                    <Button
                        onClick={() => { setOpenDeleteDialog(false); setRegistrarToDelete(null); }}
                        color="error"
                        variant="outlined"
                    >
                        Cancel
