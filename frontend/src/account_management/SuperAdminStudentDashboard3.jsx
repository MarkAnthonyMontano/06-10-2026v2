...
const SuperAdminStudentDashboard3 = () => {
    ...
    useEffect(() => {
        ...
        const tryLoad = async () => {
            ...
            const isFresh = source === "applicant_list" && Date.now() - ts < 5 * 60 * 3000;
                    ...
                    <Container maxWidth="100%" sx={{ backgroundColor: "#f1f1f1", border: `1px solid ${borderColor}`, padding: 4, borderRadius: 2, boxShadow: 3 }}>
                        ...
                        <Box display="flex" justifyContent="space-between" mt={4}>
                            <Button
                                ...
                                onClick={() => {
                                    handleUpdate(person);
                                    handleNavigateWithDelay(`/super_admin_student_dashboard2?person_id=${userID}`);
                                }}
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    handleUpdate(person);
                                    handleNavigateWithDelay(`/super_admin_student_dashboard4?person_id=${userID}`);
                                }}
