  ...
  const groupedMenu = [
    {
      ...
      items: [
        ...
        { title: "Verify Schedule Assignment", link: "/verify_document_schedule", icon: AccessTime, page_id: 115 }, // ✅ Fixed
        { title: "Evaluator Applicant List", link: "/evaluator_schedule_room_list", icon: People, page_id: 120 },
        { title: "Exam Room Assignment", link: "/assign_entrance_exam", icon: AccessTime, page_id: 9 },           // ✅ Fixed
        { title: "Proctor's Applicant List", link: "/admission_schedule_room_list", icon: People, page_id: 33 },
        { title: "Subject Management", link: "/applicant_exam_subjects", icon: School, page_id: 145 },            // ✅ Fixed: was SchoolIcon
        { title: "Announcement", link: "/announcement_for_admission", icon: Campaign, page_id: 98 },              // ✅ Fixed
        { title: "Application Process Admin", link: "/application_process_admin", icon: PersonAdd, page_id: 139 },// ✅ Fixed
      ],
    },
    {
      ...
      items: [
        ...
        { title: "Class List", link: classRosterEnrollmentLink, icon: Class, page_id: 152 },                        // ✅ Fixed: removed activeCheck (unused in render)
        { title: "Qualifying Room Mgmt", link: "/assign_qualifying_interview_exam", icon: AccessTime, page_id: 10 }, // ✅ Fixed
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Class List", link: classRosterRegistrarLink, icon: Class, page_id: 15 },                         // ✅ Fixed: removed activeCheck
